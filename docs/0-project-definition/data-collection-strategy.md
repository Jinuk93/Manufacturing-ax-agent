...
#### 6.1.4. 참고 데이터: KAMP / Bosch

- KAMP는 현재 카탈로그와 메타데이터 중심의 참고 자료로 유지
- Bosch CNC는 진동 계열 보조 데이터로 활용
- 즉, Phase 1의 출발점은 KAMP 실체 확인이 아니라 **Kaggle CNC Mill 기준 EDA + 내부 표준화 규칙 설계**입니다.
