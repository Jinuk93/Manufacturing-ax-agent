...
### 알려진 시나리오: W5 냉각수 재고 0

W5(2/12) 스냅샷에서 P003 냉각수 재고가 0으로 떨어집니다. 현실 공장이라면 긴급 발주 + 생산 일시 중단이 발생하지만, 현재 데이터에서는 exp 11~14가 정상 진행된 것으로 되어 있습니다. **Phase 2 F5 LLM 테스트 시 "재고 0인데 가공 계속?" 시나리오를 검증 케이스로 활용할 것.**
